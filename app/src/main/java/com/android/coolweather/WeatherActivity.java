...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(WeatherActivity.this,AutoUpdateTimeAcitivity.class);
        ...
        final String weatherId;//用于记录城市的天气id
        String bingPic = prefs.getString("bing_pic", null);//读取缓存的背景图片
        if (bingPic != null) {//有缓存就直接使用Glide来加载图片
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=07ee7a03ff19448c87df4017fe760eeb";//APIkey
